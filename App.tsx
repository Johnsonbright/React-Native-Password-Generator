...
const PasswordSchema = Yup.object().shape({
  passwordLength: Yup.number().min(4, 'Should be min of 4 characters').max(14, 'Should be max of 14 characters').required('Length is required')
})
     ...
     >
       {({
        ...
        <View style={styles.formActions}>
          ...
          > 
            <Text style={styles.secondaryBtnTxt}> Reset Now</Text>
            </TouchableOpacity>
        </View>
        </>
       )}
